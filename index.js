...
if (userGuess.input === "Yes") {
    ...
    inquirer
        ...
        if (userGuess.userEnterFirstTime === randomNumber) {
            console.log(chalk.bold.bgCyan("congratulations! You Guess the Correct Number"));
        }
        else if (userGuess.userEnterFirstTime !== randomNumber) {
            console.log(chalk.underline.bold.bgGreen("You choose wrong number ! You have last chance"));
            inquirer
                .prompt([
                {
